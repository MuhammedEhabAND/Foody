...
public class Meal {
    ...
    public String getStrIngredient(int i) {
        if (i >= 1 && i <= 20) {
            Field field;
            try {
                field = getClass().getDeclaredField("strIngredient" + i);
    ...
    public String getStrMeasure(int i) {
        if (i >= 1 && i <= 20) {
            Field field;
            try {
                field = getClass().getDeclaredField("strMeasure" + i);
                field.setAccessible(true);
                return (String) field.get(this);
            } catch (Exception e) {
                e.printStackTrace();
